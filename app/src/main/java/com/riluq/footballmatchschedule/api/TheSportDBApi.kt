...
import com.riluq.footballmatchschedule.BuildConfig
...
object TheSportDBApi {
    ...
    fun getEventById(idEvent: String?): String {
        return Uri.parse(BuildConfig.BASE_URL).buildUpon()
                .appendPath("api")
                .appendPath("v1")
                .appendPath("json")
    ...
    fun getSearchMatchEvent(matchEvent: String?): String {
        return Uri.parse(BuildConfig.BASE_URL).buildUpon()
                .appendPath("api")
                .appendPath("v1")
                .appendPath("json")
                ...
                .appendQueryParameter("e", matchEvent)
                .build()
                .toString()
    }
